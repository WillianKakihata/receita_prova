...
export class RecipeController {
    ...
    @Put('/:id')
    public async findByIdAndUpdate(@Param('id') id: string, @Body() body: Recipe) {
    ...
    public async addIngredient(@Param('id') id: string, @Param('idIngredient') idIngredient: string) {
        return await this.RecipeService.addIngredients(id, idIngredient)
    }
    @Put('/:id/removeingredient/:idIngredient')
    public async removeIngredient(@Param('id') id: string, @Param('idIngredient') idIngredient: string) {
